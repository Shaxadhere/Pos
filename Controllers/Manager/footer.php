    ...
    <script src="/pos/assets/template/assets/js/dashboard-one.js"></script>

    <!-- datatables-->
    <script src="/pos/assets/template/lib/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="/pos/assets/template/lib/datatables.net-dt/js/dataTables.dataTables.min.js"></script>
    <script src="/pos/assets/template/lib/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="/pos/assets/template/lib/datatables.net-responsive-dt/js/responsive.dataTables.min.js"></script>
